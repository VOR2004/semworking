package ru.itis.semworkapp.controller.account;
...
public class AccountController {
    ...
    public String updateAvatarUrl(
        ...
        redirectAttributes.addFlashAttribute("message", AccountMessages.AVATAR_UPDATED);
        log.info(AccountMessages.AVATAR_CHANGED, user.getId());
    ...
    public String updatePhoneNumber(
        ...
        redirectAttributes.addFlashAttribute("message", AccountMessages.PHONE_UPDATED);
        log.info(AccountMessages.PHONE_CHANGED, user.getId());
        return "redirect:/account";
    }
    ...
    public String updateBio(
        ...
        redirectAttributes.addFlashAttribute("message", AccountMessages.INFO_UPDATED);
        log.info(AccountMessages.INFO_CHANGED, user.getId());
        return "redirect:/account";
    }
}
